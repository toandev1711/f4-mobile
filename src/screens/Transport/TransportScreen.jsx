  ...
  return (
    <View className="flex-1 bg-white">
      <View className="bg-green-100 h-56 px-4 pt-12">
        ...
        <Image source={require('../../../assets/img/transport_1.png')} className = "absolute w-40 h-20 bottom-6 right-10"/>
        <TouchableOpacity className="absolute left-4 right-4 bottom-0 transform translate-y-1/2" onPress={() => navigateSearchSreen()}>
            <View className="flex-row items-center bg-white rounded-xl px-4 py-3 shadow-lg">
              ...
              <Text className="flex-1 text-base text-gray-800 ml-2">Where to?</Text>
